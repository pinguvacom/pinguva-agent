# Pinguva Agent Public Docs / Публичные документы агента Pinguva

## English

Public technical documentation for customers and customer-side developers.
...
Публичная техническая документация для клиентов и разработчиков на стороне клиента.
